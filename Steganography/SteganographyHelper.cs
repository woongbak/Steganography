...
namespace Steganography
{
    class SteganographyHelper
    {
        ...
        { // 함수의 효과는 인자로 입력받은 Text를 이미지파일속에 숨기는 것 //
            ...
            int charIndex = 0; // 정수형 변수 선언, 값은 0으로 초기화 //

            int charValue = 0; // 정수형 변수 선언, 값은 0으로 초기화 //

			long pixelElementIndex = 0; // 롱타입의 정수형 변수 선언, 값은 0으로 초기화, LSB에 값 저장한 갯수 저장 //

			int zeros = 0; // 정수형 변수 선언, 값은 0으로 초기화//

			int R = 0, G = 0, B = 0; // 정수형 변수 3개 선언, 값은 0으로 초기화 //
        ...
        {
            int colorUnitIndex = 0; // 정수형 변수 선언 값은 0으로 초기화 //
            int charValue = 0; // 정수형 변수 선언 값은 0으로 초기화 //
